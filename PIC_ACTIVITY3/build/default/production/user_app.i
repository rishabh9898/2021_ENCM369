...
# 149 "./configuration.h" 2

# 1 "./main.h" 1
# 150 "./configuration.h" 2
...
void UserAppRun(void)
{
<<<<<<< Updated upstream:PIC_ACTIVITY3/build/default/production/user_app.i
    u32 i;
    u8 u8Counter=0;
    while(1)
    {
...
=======
    ...
    {
        increments = 0;
>>>>>>> Stashed changes:PIC_ACTIVITY4/build/default/debug/user_app.i
    }
